...
describe("SaleService", () => {
    ...
    it('should return error when clientId not fount', async () => {
        ...
        await expect(() => saleService.save(saleCreateDto)).rejects.toThrowError('Client');
    ...
    it('should return error when product item be 0', async () => {
        ...
        const saleService = new SaleService();
        await expect(() => saleService.save(saleCreateDto)).rejects.toThrowError('Product is required');
    });
    ...
    it('should return error when productId not fount', () => {
        ...
        const saleService = new SaleService();
        expect(() => saleService.save(saleCreateDto)).rejects.toThrowError('Product with code 1 not found');
    });
    ...
    it('should return sale id when save sale', async () => {
        ...
        const saleService = new SaleService();
        const sale = await saleService.save(saleCreateDto);
        console.log(sale);
